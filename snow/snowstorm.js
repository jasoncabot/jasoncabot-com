...
var snowStorm = (function(window, document) {
  ...
  this.init = function() {
    ...
    storm.events.add(isIE?document:window,'deviceorientation',storm.deviceOrientation);
  ...
  function doDelayedStart() {
    ...
    storm.events.remove(isIE?document:window,'deviceorientation',doDelayedStart);
  }
